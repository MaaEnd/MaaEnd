...
| Runtime State Parameter Schema      | `tools/schema/components/environment_monitoring.schema.json`                      | Parameter constraints for Environment Monitoring Custom Actions; action names are registered in `tools/schema/custom.action.schema.json`                                                                                                                                           |
