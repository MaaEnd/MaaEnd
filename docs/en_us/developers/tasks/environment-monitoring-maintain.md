...
| Camera Scan | `assets/resource/pipeline/EnvironmentMonitoring/TakePhoto.json`, `agent/go-service/common/camerascan/` | Forward nine-grid scan followed by discrete upper, middle, and lower fallback rings |
