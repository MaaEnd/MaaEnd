...
| 文档 | 说明 |
| ---- | ---- |
| [快速开始](./getting-started.md) | 10 分钟内搭环境、跑程序、完成第一次改动 |
...
| [SceneManager 场景跳转](./scene-manager.md) | 万能跳转机制，从任意界面自动导航到目标场景 |
...
| [QuantizedSliding 定量滑动](./components/quantized-sliding.md) | 按目标值调节离散数量滑条的公共自定义动作 |
