...
| [MapTeleport 大地图传送](./components/map-teleport.md) | 大地图传送 Action，按区域底图坐标确认图标后点击传送点 |
...
| [SellProduct 售卖产品](./tasks/sell-product-maintain.md) | 主流程、zmdmap 精简游戏数据同步、自动干员与动态售卖循环维护 |
