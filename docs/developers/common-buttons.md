...
| **搜索范围** | **限定区域** ROI `[1181, 611, 94, 102]`（720p），仅在该区域内识别，其他位置出现的相同按钮不会点击。 |
| **动作** | 单击。 |
...
| **搜索范围** | **限定区域** ROI `[571, 594, 139, 126]`（720p），仅在该区域内识别，其他位置出现的相同按钮不会点击。 |
| **动作** | 单击。 |
...
| **搜索范围** | **限定区域** ROI `[882, 0, 398, 335]`（720p），仅在该区域内识别，其他位置出现的相同按钮不会点击。 |
| **动作** | 单击。 |
