...
var (
	...
	PUZZLE_COLOR_VAR_GRT       = 30.0
	PUZZLE_COLOR_SAT_GRT       = 0.65
	PUZZLE_COLOR_VAL_GRT       = 0.75
)
...
var (
	...
	BOARD_BLOCK_H              = 0.082 * float64(WORK_H)
	BOARD_LOCKED_COLOR_SAT_GRT = 0.65
