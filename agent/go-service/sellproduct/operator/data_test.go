...
func testSelectionData() *selectiondata.File {
	return &selectiondata.File{
		Operators: map[string]selectiondata.Operator{
		...
		Locations: map[string]selectiondata.Location{
			"TestOutpost": {
				TargetOperators: []selectiondata.TargetOperator{
...
func TestBuildOperatorSelectionDataUsesGeneratedOrder(t *testing.T) {
	got, err := buildOperatorSelectionData(testSelectionData())
	if err != nil {
...
func TestBuildOperatorSelectionDataRejectsUnknownOperator(t *testing.T) {
	...
	location.TargetOperators = append(location.TargetOperators, selectiondata.TargetOperator{Name: "Missing"})
...
func TestLoadOperatorSelectionData(t *testing.T) {
	source, err := selectiondata.Load()
	if err != nil {
		t.Fatalf("selectiondata.Load: %v", err)
	}
...
func TestResolveOperatorSelectionParamUsesDataFileCandidates(t *testing.T) {
	...
	target, err := resolveOperatorSelectionParam(&operatorRecognitionParam{
	...
	restore, err := resolveOperatorSelectionParam(&operatorRecognitionParam{
...
func TestResolveOperatorSelectionParamRejectsUnknownLocation(t *testing.T) {
	...
	_, err := resolveOperatorSelectionParam(&operatorRecognitionParam{
		Usage:    operatorUsageTarget,
		Location: "Unknown",
	})
	if err == nil {
