...
var (
	moderatePriceKeywordGroups = [][]string{
		...
		{"岳研", "Eureka", "악연"},                      // 繁体客户端仍写"岳研"，未简化为"嶽研"，故不加"嶽研"
		{"冬虫", "冬蟲", "Nymphsprout", "冬虫夏筍", "동충하순"}, // 日文无明显词界，暂保留完整词组
		{"武陵", "Wuling", "무릉"},
		{"武侠", "武俠", "Wuxia", "무협"},
	}
	largePriceKeywordGroups = [][]string{
		...
		// 英文全名 "Chubby Lung Tianshi" 首词 "Chubby" 过于笼统，改用与中文发音对应的 "Tianshi"。
		{"天师龙", "天師龍", "Tianshi", "천사"},
		{"天师桩", "天師樁"}, // 新物资，暂无 EN/JP/KR 资料
		// 息壤净/息壤色/息壤桥三者共用「Xiranite/息壌/식양」前缀，改用各自的区别词，避免互相误判。
		{"息壤净", "息壤淨", "Filter Cores", "浄水", "정수"},
		{"息壤色", "Xiran-Hue", "花火", "폭죽"},
	...
	massivePriceKeywordGroups = [][]string{
		// 韩文全名 "작은 오리지늄 나무" 首词 "작은"（小）过于笼统，改用音译词 "오리지늄"（Originium）。
		{"源石", "Originium", "오리지늄"},
		{"警戒", "Vigilant", "警戒者", "경계자"},
		{"硬脑", "硬頭殼", "Hard Noggin", "石頭", "단단한"}, // 英文仅用 "Hard" 过于笼统，保留两个词
		{"边角", "碎料", "Scrap", "端材", "재활용"},
	}
)
