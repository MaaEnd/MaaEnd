// Package selectiondata 加载货品与干员共享的 OutpostTrading 运行时生成数据。
...
// ResourcePath 是资源目录内 OutpostTrading 运行时生成数据的路径。
const ResourcePath = "data/OutpostTrading/selection_data.json"
...
// Load 读取并校验生成的 OutpostTrading 运行时数据。
