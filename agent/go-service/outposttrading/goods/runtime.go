...
import (
	...
	sellstrategy "github.com/MaaXYZ/MaaEnd/agent/go-service/outposttrading/goods/strategy"
...
func runtimeOnlyPreferredEnabledMessage() string {
	return i18n.T("outposttrading.runtime.only_preferred_enabled")
}

func runtimeStockPriorityEnabledMessage(minimumPrice int) string {
	return i18n.T("outposttrading.runtime.stock_priority_enabled", minimumPrice)
}
...
func runtimeItemAdoptedMessage(location string, itemID string) string {
	return i18n.T(
		"outposttrading.runtime.item_adopted",
		selectiondata.ItemName(itemID),
		selectiondata.LocationName(location),
	)
}
...
func runtimeItemOutOfStockMessage(location string, itemID string) string {
	return i18n.T(
		"outposttrading.runtime.item_out_of_stock",
		selectiondata.ItemName(itemID),
		selectiondata.LocationName(location),
	)
}
...
func runtimeReserveSatisfiedMessage(itemID string, quantity int) string {
	return i18n.T(
		"outposttrading.runtime.reserve_satisfied",
		selectiondata.ItemName(itemID),
		quantity,
	)
}
