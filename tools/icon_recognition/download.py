...
def download_sources(
    ...
    *,
    ...
    jobs.update(
        {
            f"lang_{locale}.json": LANG_URL.format(locale=locale)
...
def run(
    ...
    *,
    ...
    items, removals = prepare_item_map(_load_json(root / "item_mini_table.json"))
    ...
    report.update(
        {
            ...
            "duplicateRemovedCount": len(removals),
